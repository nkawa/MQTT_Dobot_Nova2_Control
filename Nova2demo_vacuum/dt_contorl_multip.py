...
class ProcessManager:
    def __init__(self):
        ...
        self.ar = np.ndarray((26), dtype=np.dtype("float32"), buffer=self.sm.buf) # 共有メモリ上の Array(0~5:現在角度、6~11:現在速度、12~17:目標角度, 18:current_topic_No, 19:grippervalue, 20:defaultFlag, 21:gripper_power, 22:gripper_min_pos, 23:touchflag, 24:topic_delay, 25:enable/disenable
        self.processes = []
    ...
    def startDashboard(self):
        self.dashboard = Nova2_dash.Nova2_DASH()
        self.dashboardP = Process(target=self.dashboard.run_proc, args=())
        self.dashboardP.start()
        self.processes.append(self.dashboardP)
